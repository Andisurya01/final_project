    ...
    useEffect(() => {
        ...
        getCourses()
            .then((res) => {
                ...
                setListText1(course.module[0].title)
                setListText2(course.module[1].title)
                setListText3(course.module[2].title)
            }).catch((err) => {
                console.log(err);
            })
                ...
                <div className="px-10">
                    ...
                    <div className="py-10">
                        ...
                        <ol className="list-decimal list-inside">
                            ...
                            <li className="py-2">Anda yang ingin belajar {listText2}</li>
