        ...
        <section className="relative">
            <div className="" onSubmit={onSubmit}>
                ...
                <div className="pb-4">
                    ...
                    className={` ${ failMail ? 'border-2 border-WARNING ' : 'border-2 border-neutral-200'} border-2 border-neutral-200 text-sm rounded-2xl px-4 py-3 w-full`} value={emailOrPhone} onChange={(e)=> setEmailOrPhone(e.target.value)} />
                </div>
                <div className="pb-4">
                    <div>
                    ...
                    className={` ${ failPass ? 'border-2 border-WARNING ' : 'border-2 border-neutral-200'} border-2 border-neutral-200 text-sm rounded-2xl px-4 py-3 w-full`}value={password} onChange={(e)=> setPassword(e.target.value)}/>
                </div>
